...
## Returns the velocity at a specific point relative to a RigidBody2D. This takes angular velocity into account.
static func get_point_velocity(node : RigidBody2D, relative_position : Vector2) -> Vector2:
